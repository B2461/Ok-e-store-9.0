...
const NotificationBell: React.FC<NotificationBellProps> = ({ notifications, onOpen, onClear, isOpen: externalIsOpen, onToggle }) => {
    ...
    return (
        <div className="relative" ref={panelRef}>
            ...
            <div className={`notification-panel absolute top-full right-0 mt-3 w-80 max-w-sm bg-slate-900/90 backdrop-blur-lg border border-gray-700 rounded-2xl shadow-2xl z-50 ${isPanelOpen ? 'open' : ''}`}>
                ...
                <div className="max-h-96 overflow-y-auto">
                    {notifications.length === 0 ? (
                        ...
                        notifications.map(n => (
                            <div key={n.id} className="flex gap-3 p-4 border-b border-white/10 last:border-b-0 hover:bg-white/5 text-left">
