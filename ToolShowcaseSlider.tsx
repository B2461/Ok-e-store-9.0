    ...
    return (
        <div className="w-full max-w-4xl mx-auto mb-8 relative">
            <div 
                ...
                className={`aspect-video bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 transition-all duration-300 hover:shadow-purple-500/20 cursor-pointer overflow-hidden active:bg-amber-500/20 active:border-amber-400 active:shadow-[0_0_20px_rgba(251,191,36,0.3)] ${currentTool.imageUrl ? 'p-0' : 'p-6 md:p-8 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8'}`}
