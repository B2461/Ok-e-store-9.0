...
const banners = [
    {
        id: 'new-banner-1',
        imageUrl: 'https://res.cloudinary.com/de2eehtiy/image/upload/w_600,q_auto:low/v1764846050/b45263c1-c531-4c89-8541-e17ded96197f_tudswh.png',
        link: '/store',
        alt: 'Special Offer'
    },
    {
        ...
        <div className="w-full max-w-7xl mx-auto mb-6 relative rounded-xl overflow-hidden shadow-2xl group border border-white/10">
            ...
            {/* Navigation Arrows */}
             <button 
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/60 text-white p-1.5 rounded-full backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity z-10"
            >
            ...
            <button 
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/60 text-white p-1.5 rounded-full backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity z-10"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
